#!/usr/bin/env python3
"""Resume i18n replacements (part 2) — files after VoiceInputField."""
import re
...
c = c.replace('{ num: 2, label: "Cover ', '{ num: 2, label: "bookBuilder.step2", icon: Palette }')  # placeholder replaced below
