      ...
      <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1">
        ...
        >
          <CoverPreview
            ...
            small
          />
          <p className="text-[8px] text-center text-muted-foreground py-1 bg-card">Cover</p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontFamily: fontConfig.css }}>
              <p className="text-[7px] font-semibold text-stone-800 mb-0.5">Morning Reflection</p>
          ...
          <p className="text-[8px] text-center text-muted-foreground py-1 bg-card">Entry Page</p>
        </motion.div>
        ...
        >
          <div className="aspect-[3/4] bg-stone-100 flex flex-col items-center justify-center p-4">
            ...
            <p className="text-[5px] text-stone-400 uppercase tracking-widest">Soul Journal</p>
          </div>
          <p className="text-[8px] text-center text-muted-foreground py-1 bg-card">Back Cover</p>
        </motion.div>
      </div>
    </div>
  );
